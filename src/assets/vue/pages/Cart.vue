        ...
        >
          ...
          <div class="sheet-modal-swipe-step">
            ...
            <div class="padding-horizontal padding-bottom">
              <f7-list>
                ...
                >
                  <select name="nominal" v-model="nominal">
              ...
              <f7-button
                ...
                fill
                @click="showPreloader()"
                sheet-close=".demo-sheet-swipe-to-step"
          ...
          <f7-list no-hairlines>
            <f7-list-item
              ...
              :title="item.title"
            >
              <b slot="after" class="text-color-black">Rp. {{ item.cost }}</b>
            </f7-list-item>
          </f7-list>
        </f7-sheet>
      </div>
...
export default {
  ...
  methods: {
    showPreloader() {
      if (parseInt(this.nominal) >= this.totalCost) {
        const kembali = parseInt(this.nominal) - this.totalCost;
        if (kembali) {
          this.$f7.preloader.show();
          setTimeout(() => {
            this.$store.commit("CLEAR_CART", Object.assign({}));
            this.$f7.preloader.hide();
            this.$f7.toast.show({
              text: `Payment Successful, don't forget the change Rp. ${kembali}`,
              position: "top",
              closeTimeout: 3000,
            });
          }, 2000);
        ...
        this.$f7.toast.show({
          text: `Nominal anda tidak cukup, silahkan pilih nominal yang sesuai`,
          position: "top",
          closeTimeout: 2000,
        });
      }
